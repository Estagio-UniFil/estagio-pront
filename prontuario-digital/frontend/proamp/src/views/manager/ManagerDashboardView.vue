    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div class="card">
            <div class="flex items-center">
                ...
                <div>
                    <p class="text-sm font-lato-regular text-muted">Equipe</p>
                    <p class="text-2xl font-lato-bold text-primary">{{ stats.teamCount }}</p>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div class="card">
            ...
            <div class="space-y-3">
                ...
                <router-link :to="{ name: 'manager-profile' }" class="btn-outline w-full">
...
const activeTeam = computed(() => userStore.pros.length);
